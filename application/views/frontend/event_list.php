    ...
    <div class="wp-section">
        <div class="container">
            <div class="row">
				...
				<?php
					$event_list = $this->db->get('events')->result_array();
					foreach($event_list as $row){
				?>
                        <li>
                            <div class="listing-image">
                                <img src="<?php echo base_url();?>upload/events_image/events_<?php echo $row['events_id'];?>.jpg" class="img-responsive" alt="">
                                <a href="<?php echo base_url();?>index.php/home/event_detail/<?php echo $row['events_id']?>" target="_blank"; class="btn btn-lg btn-square btn-gold btn-block-bm btn-icon btn-icon-go">See more</a>
                            </div>
                            <div class="cell">
                                <div class="listing-body clearfix">
                                    <h3><a href="<?php echo base_url();?>index.php/home/event_detail/<?php echo $row['events_id']?>"  target="_blank";><?php echo $row['title'];?></a></h3>
                                    <p>
                                ...
                                <div class="listing-footer">
                                    <ul class="aux-info">
                                        <li><i class="fa fa-clock-o"></i><?php echo $row['start_time'];?></li>
                                        <li><i class="fa fa-clock-o"></i><?php echo $row['end_time'];?></li>
                                        <li><i class="fa fa-map-marker"></i><strong>Venue:</strong> <?php echo $row['venue'];?></li>
                                    </ul>
                                </div>
                            </div> 
                        </li>
