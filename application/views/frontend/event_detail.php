			...
			?>
                    ...
                    <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item item-dark active">
                                <img src="<?php echo base_url();?>upload/events_image/events_<?php echo $row['events_id'];?>.jpg" alt="" class="img-responsive">
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="section-title-wr">
                        <h3 class="section-title left"><span><?php echo $row['title']?></span></h3>
                    </div>
