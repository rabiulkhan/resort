<header id="navbar">
	<link rel="icon" 
      type="image/png" 
      href="<?php echo base_url();?>/template/back/img/logo.png">
			<div id="navbar-container" class="boxed">
				<!--Brand logo & name-->
				<!--================================-->
				<div class="navbar-header">
					<a href="" class="navbar-brand">
						<img src="<?php echo base_url();?>/template/back/img/logo.png" alt="Nifty Logo" 
                        class="brand-icon" style="padding:3px;">
						<div class="brand-title">
							<span class="brand-text">Active Resort</span>
						</div>
					</a>
				</div>
				<!--================================-->
