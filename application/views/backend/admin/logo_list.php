                                ...
                                style="border-radius:3px !important;margin-top:10px !important;" 
                                        class="btn btn-warning" 
                                            data-target="#demo-lg-modal" data-toggle="modal" 
                                                onClick="modal_form('logo_add','1')">
                            <i class="entypo-user-add"></i> Upload Logo</button>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-vcenter">
								...
								<tbody>
									...
									<tr>
										<td>
                                            <img src="<?php echo base_url(); ?>upload/logo_image/logo_<?php echo $row['logo_id']; ?>.jpg" class="img-sm img-circle" width="130" />
                                        </td>
										
										<td class="min-w-td text-center">
											<a class="btn btn-sm btn-trans btn-icon btn-hover-success fa fa-pencil add-tooltip" href="#" 
												data-original-title="Edit" data-target="#demo-lg-modal" data-toggle="modal" onClick="modal_form('logo_edit',<?php echo $row['logo_id']; ?>)">
											</a>
											<a class="btn btn-sm btn-trans btn-icon btn-hover-danger fa fa-times add-tooltip" 
												href="<?php echo base_url();?>index.php/admin/logo/delete/<?php echo $row['logo_id']; ?>" data-original-title="Delete">
											</a>
											<a class="btn btn-sm btn-trans btn-icon btn-hover-warning fa fa-lock add-tooltip"
												href="#" data-original-title="View" data-target="#demo-lg-modal" data-toggle="modal" 
                                                        onClick="modal_form('logo_view',<?php echo $row['logo_id']; ?>)" >
											</a>
										</td>
									</tr>
									<?php
