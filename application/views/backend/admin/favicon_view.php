...
<h4 class="modal-title">Profile of Favicon</h4>
    ...
    <div class="col-sm-12">
        <div class="panel-body">
            ...
            <table class="table table-striped" style="border-radius:3px;">
                <tr>
                    <th class="custom_td">Favicon</th>
                    <td class="custom_td"><img src="<?php echo base_url(); ?>upload/favicon_image/favicon_<?php echo $row['favicon_id'];?>.jpg"  class="img-md img-border img-circle" alt="Profile Picture"></td>
                </tr>
