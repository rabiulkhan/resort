						 ...
						 <!--Facilities--------->
                           <!--Default checkboxes-->
							...
							<div class="panel">
								...
								<div class="panel-body">
										<!--Checkboxes labeled-->
										<label class="form-checkbox form-normal"><input type="checkbox" name = "facilities[]" value = "Children room">Children room</label>
										<label class="form-checkbox form-normal"><input type="checkbox" name = "facilities[]" value = "Living room">Living room</label>
										<label class="form-checkbox form-normal"><input type="checkbox" name = "facilities[]" value = "TV">TV</label>
									</div>
								</div>
							</div>
