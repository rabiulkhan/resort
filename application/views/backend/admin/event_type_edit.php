        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel">
                    ...
                    ?>
                    <!--Form for Accountant-->
                    <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin/event_type/do_update/<?php echo $row['event_type_id'] ?>" method="post" id="demo-bv-bsc-tabs" target="_top"  enctype="multipart/form-data">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-9 col-sm-offset-3">
                                    ...
                                    type="submit">Edit Event Type</button>
                                </div>
                            </div>
                        </div>
                        </div>  
