        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-heading">
                    <center><h3 class="panel-title">Please fill the form to create Extra Facility</h3></center>
                </div>
                <!--Form for Accountant-->
                <form class="form-horizontal" action="<?php echo base_url();?>index.php/admin/extra_facility/add" method="post" id="demo-bv-bsc-tabs" target="_top"  enctype="multipart/form-data">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-9 col-sm-offset-3">
                                ...
                                type="submit">Create Extra Facility</button>
                            </div>
                        </div>
                    </div>
                    </div>  
